        ...
        <div className="w-full h-auto  py-[7vw] sm:py-[15vw] sm:gap-[10vw]  flex-col p_r  bg-black flex sm:rounded-none">
          ...
          <div className="w-full flex justify-between h-auto items-center   sm:flex-col sm:items-start sm:gap-[5vw] sm:justify-start ">
            ...
            <div className="w-auto flex gap-[3vw] items-center sm:w-full sm:justify-staet">
              {/* <button className="font-[helvetica] h-fit capitalize  text-[1.1vw] font[900]  rounded-[39px] px-[50px] py-[16px] bg-[#ffd700] text-white hover:bg-[#ffd700]  sm:text-[4vw] sm:w-fit sm:py-[3vw] sm:px-[4vw]">
                Check our portfolio
              </button> */}
              <Link
                href={"works"}
                className="font-[helvetica] h-fit capitalize  text-[1.1vw] font[900]  rounded-[39px] px-[50px] py-[16px] bg-[#232020] text-white hover:bg-[#ffd700] sm:text-[4vw] sm:w-fit sm:py-[3vw] sm:px-[4vw]"
              >
                Check our portfolio
              </Link>
            </div>
