    ...
    <div className="bg-[black] sm:bg-[white]">
      ...
      <div className="sm:w-full w-fit flex  justify-center left-[50%]  z-[10000] sm:pb-[3vw] translate-x-[-50%]  fixed bottom-[1vw] sm:bottom-[0]">
        ...
        <button
          ...
          className={`${NeueHaasDisplay_roman.className} league sm:w-[85vw] z-[10]  shadow-sm w-[30vw] h-[5.6vw] sm:h-[13vw] text-[1.2vw] sm:text-[5vw] hover:bg-[#ffd700] bg-[#ffd700] text-white  rounded-full sm:rounded-[9.75vw]`}
        >
