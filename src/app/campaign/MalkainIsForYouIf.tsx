...
const MalkainIsForYouIf = ({ goggle }: any) => {
  const items = [
    {
      ...
      heading: (
        <>
          Most agencies recycle the same generic templates. At Qosmic, we craft
  ...
  return (
    <>
      <div
        className={`w-full flex  ${goggle ? "text-white sm:text-[black]" : ""
          ...
          {items.map((e: any, index: any) => {
            return (
              <div
                ...
                // }}
                className={` sm:h-auto   ${e.top ? `mt-[${e.top}] ` : ""} ${e.mobile_top ? `sm:mt-[${e.mobile_top}]` : ""
                  }  gap-[7vw] sm:gap-[5vw]  sm:flex-col sm:w-full  ${e.center
                  ...
                  }    flex justify-center  ${e.reverse ? "flex-row-reverse" : "flex-row"
                  }`}
              >
                {e.img && (
                  <div
                    className={`w-[50%]  aspect-video  rounded-[20px] overflow-hidden sm:w-full  ${e.reverse ? "justify-start" : "justify-end"
                      }  flex  `}
                  >
                    <Image
                      src={e.img}
                ...
                {/* the body  */}
                <div
                  className={`  sm:gap-[1rem]  sm:items-start  ${e.center
                      ? "w-full b items-center text-center "
                      : "w-[50%] sm:w-full"
                    } flex flex-col gap-[0.7vw] ${e.reverse ? "items-end" : "items-start"
                    }  `}
                >
                  ...
                  <h2
                    className={`${NeueHaasDisplay_medium.className} ${e.reverse ? "text-end" : ""
                  ...
                  <p
                    className={`${NeueHaasDisplay_roman.className
                      } text-lg sm:text-sm  sm:p-0 sm:text-start  ${e.center == true
                        ? "p-0"
                        : e.reverse
                          ? "text-end pl-[6vw]"
                          : "pr-[6rem]"
